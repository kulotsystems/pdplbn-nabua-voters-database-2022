                        ...
                        <tr>
                            ...
                            <td align="left">
                                <ul class="ul-condensed <?php echo $banner_text_class; ?>">
                                    <li class="brand-name" style="font-family: serif; text-shadow: 1px 1px #bbb"><span style="color: blue"><?php echo APP_NAME; ?> <span style="color: red"><?php echo APP_NAME_2; ?></span></span></li>
