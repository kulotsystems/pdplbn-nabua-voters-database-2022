        ...
        <nav class="page-sidebar" data-pages="sidebar">
            ...
            <div class="sidebar-menu">
                <ul class="menu-items p-t-15"><?php ret(1);
                    ...
                    echo "<li class='cursor-pointer no-selection'>";
                        echo "<a class='sidebar-menu-item-title text-success data-scan' href='#'>DATA SCAN</a>";
                        echo "<span class='icon-thumbnail border-radius-2 bg-master-darker'><a class='fa fa-search fa-fw text-success data-scan' href='#'></a></span>";
                    echo "</li>";

                    echo "<li class='cursor-pointer no-selection'>";
						echo "<a class='sidebar-menu-item-title text-danger' href='backup'>DATA BACKUP</a>";
						echo "<span class='icon-thumbnail border-radius-2 bg-master-darker'><a class='fa fa-download fa-fw text-danger' href='backup'></a></span>";
                    echo "</li>";
