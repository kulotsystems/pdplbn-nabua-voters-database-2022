...
<html lang="en">
    <head>
        <title><?php echo APP_NAME . ' ' . APP_NAME_2 . ($page != '' ? ' (' . strtoupper(implode(' ', explode('_', $page))) . ')' : ''); ?></title>
        <?php require INDEX . "ui/imports.global.php"; ?>
        <?php require INDEX . "ui/scripts.global.top.php"; ?>
    </head>
    <body class="fixed-header menu-pin menu-behind overflow-hidden hidden" data-app='<?php echo APP_NAME . ' ' . APP_NAME_2; ?>' data-index='<?php echo INDEX; ?>' data-root='<?php echo HOST_ROOT; ?>' data-page='<?php echo $page; ?>' data-dir='<?php echo $dir; ?>'>
