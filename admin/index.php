...
<html lang="en">
    <head>
        ...
        <title><?php echo APP_NAME; ?> <?php echo APP_NAME_2; ?> | Login</title>
    ...
    <body class="hidden" background="<?php echo HOST_ROOT; ?>ui/pages/assets/img/cover-v5.jpg" style="box-sizing: border-box; background-size: cover; background-blend-mode: overlay; background-repeat: no-repeat;" data-index='<?php echo INDEX; ?>' data-page='<?php echo $page; ?>' data-dir='<?php echo $dir; ?>'>
